...
##plot the graphs
    par(mfrow = c(2,2)) 
    plot(imported_hpc$Global_active_power ~ imported_hpc$DateTime, ann= FALSE, type = "n") 
    lines(imported_hpc$Global_active_power ~ imported_hpc$DateTime) 
    mtext("Global Active Power (kilowatts)", side = 2, line = 3) 
    plot(imported_hpc$Voltage ~ imported_hpc$DateTime, ann= FALSE, type = "n") 
    lines(imported_hpc$Voltage ~ imported_hpc$DateTime) 
    ...
    plot(imported_hpc$Global_reactive_power ~ imported_hpc$DateTime, ann= FALSE, type = "n") 
    lines(imported_hpc$Global_reactive_power ~ imported_hpc$DateTime) 
